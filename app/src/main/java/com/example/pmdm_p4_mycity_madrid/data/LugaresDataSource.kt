...
object LugaresDataSource {
    ...
    fun getRestaurantes(): List<Lugar> {
        return listOf<Lugar> (
    ...
    fun getApartamentos(): List<Lugar> {
        return listOf<Lugar> (
